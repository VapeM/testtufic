...
client.user.setGame(`*bc |30s Server`,"http://twitch.tv/Death Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            برودكاست عادي : s{prefix}bc
            دعوة البوت لسيرفرك :s{prefix}invite
            معلومات عن السيرفر : s{prefix}server
            برودكاست للأونلاين فقط : s{prefix}bco
            يعرض لك عدد المتبندين من سيرفرك : *{prefix}banned
            رابط سيرفر الدعم الفني : https://discord.gg/dNaCj8S
            **`);
